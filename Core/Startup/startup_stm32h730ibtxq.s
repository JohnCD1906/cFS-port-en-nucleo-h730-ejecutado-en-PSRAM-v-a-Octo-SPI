...
/* === Sanitize NVIC: disable & clear all IRQs inherited from Boot App === */
  cpsid i
  ldr   r0, =0xE000E180         /* NVIC_ICER0..ICER4 */
  ldr   r1, =0xFFFFFFFF
  str   r1, [r0, #0]
  str   r1, [r0, #4]
  str   r1, [r0, #8]
  str   r1, [r0, #12]
  str   r1, [r0, #16]
  ldr   r0, =0xE000E280         /* NVIC_ICPR0..ICPR4 */
  str   r1, [r0, #0]
  str   r1, [r0, #4]
  str   r1, [r0, #8]
  str   r1, [r0, #12]
...
/* === Sanitize SCB->CCR: clear UNALIGN_TRP & DIV_0_TRP === */
  ldr   r0, =0xE000ED14         /* SCB->CCR */
  ldr   r1, [r0]
  bic   r1, r1, #(1 << 3)       /* UNALIGN_TRP off */
  bic   r1, r1, #(1 << 4)       /* DIV_0_TRP   off */
  str   r1, [r0]
  dsb
  isb
